# -*- coding: utf-8 -*-
# Author: Lantao Li <lantao.li@sony.com>,Runsheng Xu <rxx3386@ucla.edu>, Hao Xiang <haxiang@g.ucla.edu>
...
def load_yaml(file, opt=None):
    ...
    """
    if file and opt and opt.model_dir:
        file = os.path.join(opt.model_dir, file)
