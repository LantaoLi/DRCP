...
from opencood.models.sub_modules.rfs_submodule import EfficientNetFeatureExtractor, ResNetFeatureExtractor, MulLeResNetFeatureExtractor
...
class RadianFeatureShoot(nn.Module):
    def __init__(self, args):
        ...
        elif self.camera_encoder_type == 'MulLeResNet':
            self.camencode = MulLeResNetFeatureExtractor(self.camC, target_H, target_W)
