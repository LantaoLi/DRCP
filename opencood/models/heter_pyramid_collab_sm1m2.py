...
class HeterPyramidCollabSm1m2(nn.Module):
    def __init__(self, args):
        super(HeterPyramidCollabSm1m2, self).__init__()
        self.args = args
    ...
    def forward(self, data_dict):
        ...
        print(modality_feature_dict.keys())
        if len(modality_feature_dict.keys()) == 1:
            print("1 modality")
            if 'm1' in modality_feature_dict.keys():
                print(modality_feature_dict['m1'][0][0])
                heter_feature_2d_list.append(modality_feature_dict['m1'][0][0])
            else:
                print(modality_feature_dict['m2'][0][1])
                heter_feature_2d_list.append(modality_feature_dict['m2'][0][1])
        else:
            print("2 modalities")
            heter_feature_2d_list.append(modality_feature_dict['m1'][0][0])
            heter_feature_2d_list.append(modality_feature_dict['m2'][0][1])
