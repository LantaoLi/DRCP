...
from opencood.models.fuse_modules.cross_fuse_ov import LevelDepthAwareCrossAttention
...
class PyramidCrossFusion(ResNetBEVBackbone):
    def __init__(self, model_cfg, crossfusion_cfg, input_channels=64):
        """
        ...
        # config the multi-level cross modality fusion inside the pyramidcrossfusion module
        self.cross_fusion = LevelDepthAwareCrossAttention(crossfusion_cfg).cuda()
    ...
    def forward_collab(self, spatial_features, crossfusion_tuple, record_len, affine_matrix, agent_modality_list = None, cam_crop_info = None):
        """
        ...
        # feature list cross modality fusion here
        camera_feature_2d_list, fov, rots, trans, fxs, cxs = crossfusion_tuple
        feature_list = self.cross_fusion.forward(feature_list, camera_feature_2d_list, fov, rots, trans, fxs, cxs)
